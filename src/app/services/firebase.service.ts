...
export class FirebaseService {
  ...
  private dataRefHis: AngularFirestoreCollection<Historiaclinica>;
  ...
  cargarHistoriasID(path: any): AngularFirestoreCollection<Historiaclinica> {
    this.dataRefHis = this.firestore.collection<Historiaclinica>(path);
    return this.dataRefHis;
  }
